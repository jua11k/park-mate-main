...
export function EditConvenioModal({ open, onOpenChange, tenantId, plan }: { open: boolean, onOpenChange: (open: boolean) => void, tenantId: string, plan: any }) {
      ...
      <DialogContent className="sm:max-w-md bg-black border border-white/10 text-white rounded-[2rem]">
        <DialogHeader>
          ...
          <DialogDescription className="text-white/40">
            Modifica la información del acuerdo corporativo.
          </DialogDescription>
        </DialogHeader>
